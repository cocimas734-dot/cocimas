...
const AboutPreview: React.FC = () => {
    ...
    return (
        <section className="py-20 sm:py-24 bg-gray-900/50 relative overflow-hidden border-t border-gray-800">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8">
                            {values.map((value, index) => (
                                ...
                                >
                                    ...
                                    <h3 className="font-display font-bold text-gold-500 mb-2 truncate">{value.title}</h3>
                        ...
                        <Link
                            to="/nosotros"
                            className="inline-flex items-center gap-3 bg-gold-500 text-black-900 px-6 sm:px-8 py-4 font-bold uppercase tracking-wider hover:bg-gold-400 transition-all duration-300 group text-sm sm:text-base w-full sm:w-auto justify-center"
                        >
                    ...
                    <div className="relative mt-8 lg:mt-0">
                        ...
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/10 aspect-[4/3] sm:aspect-[16/9] lg:aspect-[4/3]">
                            <img
                                alt="Equipo Cocimás"
