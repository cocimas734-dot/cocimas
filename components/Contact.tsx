          ...
          <div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h5 className="text-white font-bold uppercase tracking-wider text-sm mb-2">Teléfonos</h5>
                  <p className="text-gray-400 text-sm">{CONTACT_INFO.phonePrimary}</p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h5 className="text-white font-bold uppercase tracking-wider text-sm mb-2">Correos</h5>
                  <p className="text-gray-400 text-sm">{CONTACT_INFO.emailPrimary}</p>
                  <p className="text-gray-400 text-sm">{CONTACT_INFO.emailSecondary}</p>
                </div>
              </div>
            </div>
